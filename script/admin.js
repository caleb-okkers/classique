document.addEventListener("DOMContentLoaded", function() {
                        ...
                        <div class="">
                            ...
                            <div class="modal fade" id="updateProduct${product.id}" tabindex="-1" aria-labelledby="updateProduct${product.id}" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button type="button" class="btn btn-outline-success" onclick='updateProduct(${JSON.stringify(product)}, ${i})'><span class="text-light">Save changes</span></button>
                                </div>
                              </div>
                                </div>
                            </div>
    ...
    window.updateProduct = function(item, index) {
        try {
            ...
            adminContent(products);
            document.querySelector(`#updateProduct${item.id} .btn-close`).click();
        } catch (e) {
    ...
    adminSavedProduct.addEventListener('click', () => {
        try {
            ...
            localStorage.setItem('products', JSON.stringify(products));
            adminContent(products);
            document.querySelector('#adminAddProduct .btn-close').click();
        } catch (e) {
